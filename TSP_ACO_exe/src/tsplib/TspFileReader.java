...
/**
 * Algoritm adaptat dupa https://github.com/schmittjoaopedro/aco-tsp-java/blob/master/src/main/java/schmitt/joao/aco/TspReader.java
 */
public class TspFileReader {
    ...
    public static double[][] getDistances(String path, String file) {
        return TspFileReader.getDistances(new File(path, file).toString());
    }

    public static double[][] getCoordinates(String path, String file) {
        return TspFileReader.getCoordinates(new File(path, file).toString());
    }
